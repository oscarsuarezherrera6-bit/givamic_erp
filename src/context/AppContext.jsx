...
function patchMissing(parsed) {
  ...
  const USUARIOS_PRUEBA = [
    { id: 'u1',  nombre: 'Administrador ERP',              email: 'admin@givamic.pe',          password: 'admin123',     rol: 'Administrador',                   rolERPId: 'rol-admin',     jefeDirectoId: null  },
    { id: 'u2',  nombre: 'Oscar Suarez (Coord. Logística)', email: 'logistica@givamic.pe',      password: 'logistica123', rol: 'Coordinador Logística y Compras', rolERPId: 'rol-coord-log', jefeDirectoId: 'u1'  },
    { id: 'u3',  nombre: 'Administradora de Empresa',       email: 'administradora@givamic.pe', password: 'empresa123',   rol: 'Administrador de Empresa',        rolERPId: 'rol-gerencia',  jefeDirectoId: 'u1'  },
    { id: 'u4',  nombre: 'Contador',                        email: 'contador@givamic.pe',       password: 'conta123',     rol: 'Contador',                        rolERPId: 'rol-colab',     jefeDirectoId: 'u3'  },
    { id: 'u5',  nombre: 'Coordinador General',             email: 'coord.general@givamic.pe',  password: 'coordgen123',  rol: 'Coordinador General',             rolERPId: 'rol-coord-gen', jefeDirectoId: 'u1'  },
    { id: 'u6',  nombre: 'Coordinador Operaciones',         email: 'coord.ops@givamic.pe',      password: 'coordops123',  rol: 'Coordinador Operaciones',         rolERPId: 'rol-jefe-area', jefeDirectoId: 'u1'  },
    { id: 'u7',  nombre: 'Jefe RRHH',                       email: 'jefe.rrhh@givamic.pe',      password: 'jrrhh123',     rol: 'Jefe RRHH',                       rolERPId: 'rol-jefe-area', jefeDirectoId: 'u1'  },
    { id: 'u8',  nombre: 'Asistente RRHH',                  email: 'asist.rrhh@givamic.pe',     password: 'arrhh123',     rol: 'Asistente RRHH',                  rolERPId: 'rol-colab',     jefeDirectoId: 'u7'  },
    { id: 'u9',  nombre: 'Asistente Logística',             email: 'asist.log@givamic.pe',      password: 'alog123',      rol: 'Asistente Logística',             rolERPId: 'rol-colab',     jefeDirectoId: 'u2'  },
    { id: 'u10', nombre: 'Facturación',                     email: 'facturacion@givamic.pe',    password: 'factura123',   rol: 'Facturación',                     rolERPId: 'rol-colab',     jefeDirectoId: 'u1'  },
    { id: 'u11', nombre: 'Auditor ISO',                     email: 'auditor@givamic.pe',        password: 'auditor123',   rol: 'Auditor',                         rolERPId: 'rol-auditor',   jefeDirectoId: 'u1'  },
    { id: 'u12', nombre: 'Asistente SSOMA',                 email: 'asist.ssoma@givamic.pe',    password: 'assoma123',    rol: 'Asistente SSOMA',                 rolERPId: 'rol-colab',     jefeDirectoId: 'u13' },
    { id: 'u13', nombre: 'Jefe SSOMA',                      email: 'jefe.ssoma@givamic.pe',     password: 'jssoma123',    rol: 'Jefe SSOMA',                      rolERPId: 'rol-jefe-area', jefeDirectoId: 'u1'  },
    { id: 'u14', nombre: 'Lucas (RRHH)',                    email: 'lucas.rrhh@givamic.pe',     password: 'lucas123',     rol: 'Asistente RRHH',                  rolERPId: 'rol-colab',     jefeDirectoId: 'u7'  },
  ]
...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case 'ADD_USUARIO':    next = { ...state, usuarios: [...(state.usuarios||[]), { id: genId(), ...action.payload }] }; break
    case 'UPDATE_USUARIO':
